...
public class Box implements Cloneable {
    ...
    public Box(String addresser, String recipient, double weight, double volume) {
        ...
        this.weight = weight;
        this.volume = volume;
        this.cost = NewPostOffice.calculateCostOfBox(weight, volume, 100);
    }
    public Box(String sender, String recipient, double weight, double volume, BigDecimal shippingCost) {
        this(sender, recipient, weight, volume);
        this.cost = cost;
    }
